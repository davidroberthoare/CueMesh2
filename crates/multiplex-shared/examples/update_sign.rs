...
//!
//! ```sh
//! MULTIPLEX_SIGNING_KEY=<base64 private key> \
//!   cargo run -p multiplex-shared --example update_sign -- \
//!   clients x86_64-unknown-linux-gnu path/to/multiplex-client
//! ```
//!
...
fn main() -> anyhow::Result<()> {
    let key = std::env::var("MULTIPLEX_SIGNING_KEY")
        .map_err(|_| anyhow::anyhow!("set MULTIPLEX_SIGNING_KEY to the base64 private key"))?;
